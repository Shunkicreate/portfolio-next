                ...
                <div className='relative w-60 h-32 flex-shrink-0'>
                    <a href={site.url}>
                        <div className='absolute left-0 top-0 w-full h-full flex items-center justify-center'>
                            <img alt={ site.name + 'ogp image'} className='absolute left-0 top-0 w-full h-full object-cover object-center transition duration-50' loading='lazy' src={site.ogpImage} />
                        </div>
                    </a>
                </div>
                <div className='p-8'>
