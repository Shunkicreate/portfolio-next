          ...
          <div className="col-md-6 col-12">
            <div className="row justify-content-center row-content text-start gy-3">
              ...
              <div>
                ...
                was obsessed with it when I was a first year in college. The web
                site only works on a PC. The video is my tweet. The video is my
                tweet.
              </div>
              <div className="col-md-12 text-start">
                <div className="row justify-content-evenly text-start">
                  <div className="col-md-2 col-auto text">
                    ...
                    >
                      <button type="button" className="btn btn-outline-secondary">website</button>
                    </a>
                  </div>
                  <div className="col-md-2 col-auto text">
                    <a
                    ...
                    >
                      <button type="button" className="btn btn-outline-secondary">Video</button>
                    </a>
                  </div>
                </div>
              </div>
